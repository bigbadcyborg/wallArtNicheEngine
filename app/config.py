...
class Settings:
    ...
    image_provider: str = os.environ.get("IMAGE_PROVIDER", "gemini").lower()
    comfyui_base_url: str = os.environ.get("COMFYUI_BASE_URL", "http://127.0.0.1:8188")
    comfyui_workflow_path: str | None = os.environ.get("COMFYUI_WORKFLOW_PATH")
    comfyui_timeout_seconds: float = float(os.environ.get("COMFYUI_TIMEOUT_SECONDS", "120"))
    comfyui_output_node_id: str | None = os.environ.get("COMFYUI_OUTPUT_NODE_ID")
    comfyui_prompt_node_id: str | None = os.environ.get("COMFYUI_PROMPT_NODE_ID")
