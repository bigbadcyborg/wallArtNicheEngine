...
class Settings:
    ...
    comfyui_base_url: str | None = os.environ.get("COMFYUI_BASE_URL")
    comfyui_workflow_path: str | None = os.environ.get("COMFYUI_WORKFLOW_PATH")
    comfyui_model_label: str = os.environ.get("COMFYUI_MODEL_LABEL", "comfyui")
    comfyui_timeout_seconds: float = float(os.environ.get("COMFYUI_TIMEOUT_SECONDS", "300"))
